...
const COMMANDS: Readonly<Record<string, readonly [file: string, ...args: string[]]>> =
  Object.freeze({
    ...
    'report-compatibility-read-surfaces': [
      'scripts/ops/report-compatibility-read-surfaces.ts',
    ],
    'report-guest-response-readiness': ['scripts/ops/report-guest-response-readiness.ts'],
    'report-inbox-handling-cutover': ['scripts/ops/report-inbox-handling-cutover.ts'],
    'report-legacy-custom-roles': ['scripts/ops/report-legacy-custom-roles.ts'],
    'report-legacy-guest-compatibility': [
      'scripts/ops/report-legacy-guest-compatibility.ts',
    ],
    'report-legacy-multi-org': ['scripts/ops/report-legacy-multi-org.ts'],
    'report-non-fk-references': ['scripts/ops/report-non-fk-references.ts'],
    'report-organization-lifecycle': ['scripts/ops/report-organization-lifecycle.ts'],
    'report-portal-artifacts': ['scripts/ops/report-portal-access-artifacts.ts'],
    'report-portal-beta-readiness': ['scripts/ops/report-portal-beta-readiness.ts'],
