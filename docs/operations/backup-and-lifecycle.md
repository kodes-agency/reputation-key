...
The former Review row-delete schedule is deliberately absent: SAFE-03
quarantines its handler until REV-01 storage separation and reply-preservation
evidence exist. Expired source content remains ineligible for serving, but this
containment is not compliant storage erasure and therefore blocks external beta.

| Subject                                     | Table / store                                      | TTL / trigger                                                                                                                                                                       | Mechanism                                                                                                     |
| ------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `reviews.purge`                             | `reviews` (expired)                                | Source policy: raw content 30d from last fetch (refresh-due 25d) — ADR 0031, no grace                                                                                               | **Quarantined:** no recurring schedule and no mutation; REV-01 field-level erasure is required before release |
