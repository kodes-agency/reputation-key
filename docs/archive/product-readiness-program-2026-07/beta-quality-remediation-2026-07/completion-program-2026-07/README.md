...
**Program code:** BQC  
**Status:** Local evidence complete — five post-evidence approvals pending  
**Created:** 2026-07-17  
**Target:** controlled internal beta backed by `beta-local-1` synthetic acceptance  
**Capacity model:** deterministic local fixtures at 5,000 properties / 500,000 reviews  
...
12. [BQC-8 — local scale, recovery, and release evidence](phase-bqc8-scale-recovery-release.md)
13. [BQC-9 — local product acceptance and operations handoff](phase-bqc9-pilot-and-handoff.md)
...
| BQC-8 | Local scale, lifecycle, faults, migration, and immutable evidence pass         |         Evidence complete | BQC-6 and BQC-7                                    |
| BQC-9 | Local product acceptance passes; five independent approvals remain             | Approval evidence pending | BQC-0 through BQC-8                                |
...
- Synthetic/disposable data only until BQC-9 is accepted with five post-evidence approvals.
