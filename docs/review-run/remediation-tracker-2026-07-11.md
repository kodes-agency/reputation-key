...
| DOC-05 | Numbered headings instead of plain                                                                 | src/contexts/notification/CONTEXT.md                                                      | MAJOR    | docs/standards.md §4.1                              | Doc update        | Remove "1. ", "2. " etc. prefixes                                                     | Fixed (partial) | Phase 1 - first heading fixed (## Bounded context); others still numbered          |
