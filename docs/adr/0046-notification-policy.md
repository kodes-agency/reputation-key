...
reason. Reviews observed as ongoing (`measured`) or `legacy_unknown` notify as
before, a later material revision still notifies as `review.updated`, and
private feedback is unaffected. The shared fan-out reads the fact through
