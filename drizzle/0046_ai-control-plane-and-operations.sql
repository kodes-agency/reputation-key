...
CREATE TABLE "ai_provider_deployment_profiles" (
	...
	CONSTRAINT "ai_provider_profiles_model_valid" CHECK ("ai_provider_deployment_profiles"."model_snapshot" = 'gpt-5.4-mini-2026-03-17'),
