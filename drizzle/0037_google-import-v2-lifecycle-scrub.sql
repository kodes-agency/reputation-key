...
ALTER TABLE "gbp_import_request_items" DROP CONSTRAINT "gbp_import_request_items_generations_valid";--> statement-breakpoint
ALTER TABLE "gbp_import_request_items" ALTER COLUMN "expected_connection_lifecycle_version" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "gbp_import_request_items" ALTER COLUMN "expected_connection_access_version" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "gbp_import_request_items" ALTER COLUMN "expected_credential_generation" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "gbp_import_request_items" ADD CONSTRAINT "gbp_import_request_items_generations_valid" CHECK ((
        (
          (
