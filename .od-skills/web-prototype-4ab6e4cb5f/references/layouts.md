...
<section class="section" data-od-id="hero-split">
  <div class="container hero-split">
    ...
    <div class="ph-img wide" aria-label="Hero visual placeholder">
      [ Hero visual · 16:9 ]
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid-3">
      ...
      <div class="stat">
        ...
        <p class="stat-label">
          average egress saved — typical $1,800/mo bill drops to $200.
        </p>
      </div>
    </div>
  </div>
...
<section class="section" data-od-id="quote">
  <div class="container" style="max-width: 800px;">
    ...
    <blockquote class="quote">
      Filebase pays for itself in the first month. We were going to hire a dedicated
      DevOps person to babysit our sync — instead we just switched.
    </blockquote>
    ...
    <div>
      <article class="log-row">
        ...
        <div>
          ...
          <p style="margin: 4px 0 0; color: var(--muted); font-size: 14px;">
            A new content-defined chunker that produces 38× fewer post-edit changes on
            Final Cut projects.
          </p>
        </div>
      ...
      <article class="log-row">
        ...
        <div>
          ...
          <p style="margin: 4px 0 0; color: var(--muted); font-size: 14px;">
            Cap how much a single project can pull each month — useful for archive
            folders.
          </p>
        </div>
