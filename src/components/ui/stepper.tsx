// Vendored from Dice UI (https://diceui.com/docs/components/radix/stepper),
// registry item @diceui/stepper, Radix base, fetched 2026-09-15. MIT licensed.
// Local changes: import paths only. Keep diffs against upstream minimal so a
// later refresh stays a copy.
