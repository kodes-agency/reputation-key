// One honest fixture factory for every notification story.
//
...
export const notificationFixtures: ReadonlyArray<Notification> = [
  ...
  makeNotification({
    ...
    status: 'unread',
    propertyId: RIVERSIDE,
    payload: { propertyName: 'Riverside Hotel', rating: 1, waitingHours: 5 },
    coalescedCount: 3,
  ...
  makeNotification({
    ...
    status: 'unread',
    propertyId: HARBOUR,
    payload: { propertyName: 'Harbour View Suites', rating: 5, platform: 'google' },
