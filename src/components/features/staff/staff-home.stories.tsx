...
// decision lives in the useStaffHomeData hook (four suspense queries via the
...
//
// States: Populated (KPIs + goals + recent activity), Loading
...
// Populated — responsible portals, KPIs, goals and recent reviews all
