...
export const inboxItems = pgTable(
  ...
  (t) => [
    ...
    // Cross-tenant scan for the missing-notification gauge (the Feed
    // notification-gap read): "items created in the last N hours", ordered
    // by (created_at, id). source_date is the review's own date, so
