...
describe('isTransientConnectionError', () => {
  ...
  it('recognises ECONNRESET and EPIPE (recycled-connection symptoms)', () => {
    expect(isTransientConnectionError(Object.assign(new Error('x'), { code: 'ECONNRESET' }))).toBe(
      true,
    )
    expect(isTransientConnectionError(Object.assign(new Error('x'), { code: 'EPIPE' }))).toBe(true)
  })
