...
export const PROSE_TERMS = Object.freeze([
  ...
  {
    directory: 'guest',
    term: 'findPortalIdForFeedback',
    reason: 'Method on the exported `GuestFeedbackAttributionPublicApi` facade.',
  },
  {
    directory: 'guest',
    term: 'getPortalResponseIntegritySummary',
    reason: 'Method on the exported `GuestResponseIntegrityPublicApi` facade.',
  },
  {
    directory: 'guest',
    term: 'PortalId',
    reason:
      'Shared branded identifier from `#/shared/domain/ids`. Guest names the identifier it returns; it neither owns nor re-exports the type.',
  },
  {
    directory: 'guest',
    term: 'Accepted',
    reason:
      'Human-facing integrity-summary label. The exported summary carries a counted field, not a symbol with this name.',
  },
  {
    directory: 'identity',
    term: 'managerFacts',
    reason: 'Field of the exported `IdentityPublicApi` facade, not a module export.',
  },
  {
    directory: 'identity',
    term: 'accountAdminAuthority',
    reason: 'Field of the exported `IdentityPublicApi` facade, not a module export.',
  },
  {
    directory: 'identity',
...
export const DOCUMENTED_ELSEWHERE = Object.freeze([
  {
    directory: 'ai',
    reason:
      'AI CONTEXT.md documents its surface as families — governed aggregate reads, on-demand Reply Drafting inputs/results, current read models, identifier-only events and the tagged-error guard — instead of name by name. The exhaustive list lives here so a new AI export fails this check until it is documented or reviewed.',
    names: [
      'AiCapability',
      'AiCategoryCount',
      'AiError',
      ...
      'ReviewAnalysisEnrollmentReadiness',
  ...
  },
  {
    directory: 'dashboard',
    reason:
      'Dashboard CONTEXT.md enumerates the read models it serves; these Google Performance, fleet-evidence, Portal-metric and setup-action contracts are not yet in that enumeration.',
    names: [
      'FleetMetricEvidence',
  ...
  },
  {
    directory: 'guest',
    reason:
      'Guest CONTEXT.md names its two cross-context facades by the behaviour they expose rather than by type name.',
    names: [
      'GuestFeedbackAttributionPublicApi',
      'GuestResponseIntegrityPublicApi',
      'PortalResponseIntegritySummary',
    ],
  },
  {
    ...
    names: [
      ...
      'InboxHandlingCutoverReportInput',
      'InboxHandlingCutoverReportPayload',
      'InboxHandlingCycleClosed',
      'InboxHandlingCycleOpened',
      'InboxHandlingCycleReopened',
      'InboxItemDetailResult',
      'InboxItemEscalationResolved',
      'InboxLegacyClassification',
      'InboxLegacyCycleRow',
      'InboxLegacyHeadRow',
      'InboxLegacyItemRow',
      'InboxLegacyNoteRow',
      'InboxLegacyOutcomeRow',
      'InboxLegacyReasonCode',
      'InboxLegacyRelationship',
      'InboxLegacyRelationshipInput',
      'InboxLegacySourceAnchorRow',
      'InboxLegacyTransitionRow',
      'InboxPublicApi',
  ...
  },
  {
    ...
    reason:
      'Leaderboard CONTEXT.md describes one content-free inventory model and its canonical formatter; the legacy Recognition table names stay unlisted so the document keeps reading as dark-capability history rather than as an API.',
    names: [
  ...
  },
  {
    directory: 'property',
    reason:
      'Property CONTEXT.md enumerates the current facades and the Google binding contract; these lifecycle events, region guards and import builders are not yet in that enumeration.',
    names: [
      'BuildGoogleImportedPropertyInput',
      'GoogleBindingState',
