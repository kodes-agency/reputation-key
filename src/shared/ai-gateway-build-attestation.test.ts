...
describe('AI gateway build attestation', () => {
  it('has a stable domain-separated digest and every registered artifact exists', () => {
    ...
    const paths = [
      ...
      AI_GATEWAY_BUILD_ATTESTATION_V1.image.railwayConfig,
      ...
      AI_GATEWAY_BUILD_ATTESTATION_V1.syntheticCanary.railwayConfig,
      ...
      AI_GATEWAY_BUILD_ATTESTATION_V1.runtimeEgressProbe.railwayConfig,
