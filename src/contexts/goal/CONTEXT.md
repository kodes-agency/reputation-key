...
- Type: `Goal`
- Program contracts: `GoalProgram`, `GoalProgramError`, `GoalExecutionPolicy`
- Subject and assignment contracts: `GoalSubject`, `GoalSubjectAssignment`, `GoalAssignmentChangeOutcome`
- Metric vocabulary: `GoalMetric`
- Results matrix read model: `GoalResultsMatrix`, `GoalResultsMatrixRow`, `GoalResultsMatrixEvidence`, `buildGoalResultsMatrix`
- Notification fact contracts: `MonthlyResultNotificationFactsLookup`, `MonthlyResultRevisionNotificationFacts`
- Event types: `GoalCompleted`, `GoalMonthlyResultClosed`, `GoalMonthlyResultReconciled`, `GoalEvent`
- Event constructor: `goalMonthlyResultClosed`
