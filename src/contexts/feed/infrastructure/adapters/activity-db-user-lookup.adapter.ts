// Feed activity surface — DB-backed user lookup adapter for BullMQ worker
...
import type { UserLookupPort, UserInfo } from '../../ports/activity-user-lookup.port'
...
export const createActivityDbUserLookupAdapter = (db: Database): UserLookupPort => ({
