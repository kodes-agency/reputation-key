...
import { createNotificationDbUserLookupAdapter } from './notification-db-user-lookup.adapter'
...
describe('createNotificationDbUserLookupAdapter.findByRole', () => {
  ...
  it('returns only current members with the requested built-in role', async () => {
    ...
    const lookup = createNotificationDbUserLookupAdapter(
