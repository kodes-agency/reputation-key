...
const source = readFileSync(
  resolve(process.cwd(), 'src/contexts/feed/server/activity.ts'),
  'utf8',
)
...
describe('Operational Action History server reachability', () => {
  it('declares both restricted GET boundaries behind policy.admin', () => {
    for (const name of [
      ...
      expect(declaration).toContain('feedPublicApi.')
  ...
  it('catalogues their direct reachability and Feed-local access evidence', () => {
