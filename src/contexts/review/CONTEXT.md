...
- Provider read contracts: `GoogleReviewGetRequest`, `GoogleReviewGetResult`, `GoogleReviewPage`, `GoogleReviewPageRequest`, `GoogleReviewApiError`, `GoogleReviewApiErrorCode`
- Provider snapshot contracts: `RunReviewProviderSnapshot`, `RunReviewProviderSnapshotInput`, `RunReviewProviderSnapshotResult`, `ReviewProviderSnapshotRun`, `ReviewProviderSnapshotRepository`, `ReviewProviderSnapshotFailureCode`, `ReviewProviderObservationWriter`, `ReviewProviderObservationOrigin`, `ReviewProviderJobData`
- Targeted fetch contracts: `RunTargetedGoogleReviewFetch`, `RunTargetedGoogleReviewFetchInput`, `RunTargetedGoogleReviewFetchResult`, `TargetedGoogleReviewFetchJobData`, `TargetedGoogleReviewQueuePort`, `TargetedGoogleReviewReferenceResolver`
- Content-free AI source contracts: `AiReviewSourceRequest`, `AiReviewSourceResult`, `AiReviewSourceExpectation`, `AiReviewSourceDenial`, `AiReviewCurrentSource`, `AiReviewCurrentSourceResult`, `AiReviewObservation`, `AiTrendPopulationRequest`, `AiTrendPopulationResult`, `AiTrendPopulationReview`
- Exact-current permits and their expectations: `ReviewCurrentReplyObservationPermit`, `ReviewReplyObservationExpectation`, `ReviewReplyObservationAuthorityResult`, `ReviewCurrentResponseTargetPermit`, `ReviewResponseTargetExpectation`, `ReviewResponseTargetEligibility`, `ReviewResponseTargetAuthorityResult`, `ReviewCurrentSourceTransitionPermit`, `ReviewSourceTransitionExpectation`, `ReviewSourceTransitionChange`, `ReviewSourceTransitionAuthorityResult`, `ReviewCurrentInboxProjectionPermit`, `ReviewInboxProjectionExpectation`, `ReviewInboxProjectionRevisionPermit`, `ReviewInboxProjectionEventKind`
- Publication reconciliation: `ReconcileReplyPublication`, `ReconcileReplyPublicationInput`, `FindAmbiguousPublicationReconciliationCandidates`, `PublicationReconciliationCandidateQuery`, `AmbiguousPublicationReconciliationCandidate`, `AmbiguousPublicationReconciliationCursor`
- Source content lifecycle: `collectReviewSourceContentLifecycleReport`, `CollectReviewSourceContentLifecycleReportInput`, `ReviewSourceContentLifecycleReportSummary`, `REVIEW_SOURCE_CONTENT_LIFECYCLE_MAX_BATCH_SIZE`, `SourceContentPurge`, `SourcePurgeContinuation`, `SourcePurgeResult`
- Recovery and fixed values: `ReviewLifecycleRecoveryAuthorityFactory`, `ReviewLifecycleRecoveryApprovalConfiguration`, `MAX_REPLY_LENGTH`, `GBP_PUSH_SYNC_INITIATOR_ID`, `GOOGLE_PROPERTY_IMPORT_SYNC_INITIATOR_ID`
...
- Event constructors: `reviewCreated`, `reviewUpdated`, `reviewGoogleReputationSnapshotVerified`, `reviewReplyPublished`, `reviewReplyObserved`, `reviewReplySubmitted`, `reviewReplyApproved`, `reviewReplyUpdated`, `reviewReplyPublicationRequested`, `reviewReplyPublicationCancelled`, `reviewReplyRejected`, `reviewReplyPublishFailed`, `reviewExpired`
