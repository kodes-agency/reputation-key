...
export type ReplyRepository = Readonly<{
  findByReviewId(reviewId: ReviewId, organizationId: OrganizationId): Promise<ReadonlyArray<Reply>>
  ...
  deleteByReviewIdAndSource(reviewId: ReviewId, source: ReplySource, organizationId: OrganizationId): Promise<void>
}>
