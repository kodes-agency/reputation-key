...
export function shouldSuppressDelivery(state: EmailQueueStatus): boolean {
  return state === 'bounced' || state === 'complained' || state === 'suppressed'
}
