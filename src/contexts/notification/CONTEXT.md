...
| `goal.monthly_result.closed`                          | goal        | For an exact current closed-and-achieved result, enqueue `goal.completed` to current responsible recipients for its Property, Portal Group, or Portal scope.                                                                                                                                                                                                    |
