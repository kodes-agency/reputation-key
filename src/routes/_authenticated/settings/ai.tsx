...
function MerchantAiSettingsRoute() {
  ...
  return (
    <>
      <PageHeader
        title="AI data use"
        description="Control which AI-assisted features may process Google review data for each property."
        breadcrumbs={[{ label: 'Settings', to: '/settings' }, { label: 'AI data use' }]}
      />
      <div className="mt-6">
