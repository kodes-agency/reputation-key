...
// and a test can pin it, rather than accumulated across fourteen build calls.
//
...
import { createActivityOrganizationExportContributor } from '#/contexts/feed/infrastructure/adapters/activity-organization-export.adapter'
import { createAiOrganizationExportContributor } from '#/contexts/ai/infrastructure/adapters/ai-organization-export.adapter'
import { createDashboardOrganizationExportAdapter } from '#/contexts/reporting/infrastructure/adapters/dashboard-organization-export.adapter'
import { createGoalOrganizationExportAdapter } from '#/contexts/reporting/infrastructure/adapters/goal-organization-export.adapter'
...
import { createMetricOrganizationExportAdapter } from '#/contexts/reporting/infrastructure/adapters/metric-organization-export.adapter'
import { createNotificationOrganizationExportContributor } from '#/contexts/feed/infrastructure/adapters/notification-organization-export.adapter'
...
import { createDashboardOrganizationLifecycleAdapter } from '#/contexts/reporting/infrastructure/adapters/dashboard-organization-lifecycle.adapter'
import { createGoalOrganizationLifecycleAdapter } from '#/contexts/reporting/infrastructure/adapters/goal-organization-lifecycle.adapter'
...
import { createMetricOrganizationLifecycleAdapter } from '#/contexts/reporting/infrastructure/adapters/metric-organization-lifecycle.adapter'
import { createNotificationOrganizationLifecycleContributor } from '#/contexts/feed/infrastructure/adapters/notification-organization-lifecycle.adapter'
 ...
 *
 * The thirteen contributors are always composed, because a partial set is the
 ...
 * fourteen missing contexts, which is the honest state.
 *
